<#
.SYNOPSIS
Provides the PowerShell logic in `tests/contract/Find-ModuleUpgradeImpact.Local.Contract.Tests.ps1`.

.DESCRIPTION
Contains test or fixture PowerShell logic for `tests/contract/Find-ModuleUpgradeImpact.Local.Contract.Tests.ps1`.
#>
