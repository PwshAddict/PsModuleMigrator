<#
.SYNOPSIS
Provides the PowerShell logic in `tests/fixtures/modules/Az.Storage/4.0.0/Az.Storage.psm1`.

.DESCRIPTION
Contains test or fixture PowerShell logic for `tests/fixtures/modules/Az.Storage/4.0.0/Az.Storage.psm1`.
#>
