<#
.SYNOPSIS
Provides the PowerShell logic in `tests/unit/Find-CodebaseModuleUsage.Local.Tests.ps1`.

.DESCRIPTION
Contains test or fixture PowerShell logic for `tests/unit/Find-CodebaseModuleUsage.Local.Tests.ps1`.
#>
