<#
.SYNOPSIS
Provides the PowerShell logic in `tests/integration/Find-ModuleUpgradeImpact.Repository.Tests.ps1`.

.DESCRIPTION
Contains test or fixture PowerShell logic for `tests/integration/Find-ModuleUpgradeImpact.Repository.Tests.ps1`.
#>
